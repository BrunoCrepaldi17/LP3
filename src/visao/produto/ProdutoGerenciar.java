...
public class ProdutoGerenciar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Unidade de Medida", "Data do Cadastro"
            }
        ) {
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        ProdutoCadastrar uc = new ProdutoCadastrar();
        uc.setVisible(true);
        uc.produtoGerenciarForm = this;
    ...
    private void alterar() {
        ...
        if (linhaSelecionada != -1) {
            ...
            form.produtoGerenciarForm = this;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoGerenciar.class
