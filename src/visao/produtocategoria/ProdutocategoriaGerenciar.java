...
public class ProdutocategoriaGerenciar extends javax.swing.JFrame {

    public ProdutocategoriaGerenciar() {
        initComponents();
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        ProdutocategoriaCadastrar uc = new ProdutocategoriaCadastrar();
        uc.setVisible(true);
        uc.produtocategoriaGerenciarForm = this;
    ...
    private void preencherTabela(String campoPesquisa) {
        ...
        try {
            ...
            for (Produtocategoria obj : lista) {
                String[] linha = {
                    obj.getId().toString(),
                    obj.getNome(),
                    ""
    ...
    private void alterar() {
        ...
        if (linhaSelecionada != -1) {
            ...
            ProdutocategoriaAlterar form = new ProdutocategoriaAlterar();
            form.setVisible(true);
            form.produtocategoriaGerenciarForm = this;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutocategoriaGerenciar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProdutocategoriaGerenciar().setVisible(true);
            }
        });
    }
