...
public class UsuariogrupoGerenciar extends javax.swing.JFrame {
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        UsuariogrupoCadastrar uc = new UsuariogrupoCadastrar();
        uc.setVisible(true);
        uc.usuariogrupoGerenciarForm = this;
    ...
    private void alterar() {
        ...
        if (linhaSelecionada != -1) {
            ...
            UsuariogrupoAlterar form = new UsuariogrupoAlterar();
            form.setVisible(true);
            form.usuariogrupoGerenciarForm = this;
